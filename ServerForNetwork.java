...
// Server class 
public class ServerForNetwork
{ 
	public static final Logger logger = Logger.getLogger(ServerForNetwork.class.getName()); //inicialize logger

	public static void main(String[] args) throws IOException {

		FileHandler fh;
		// настройка вывода логов в файл и выключение вывода логов в консоль
		fh = new FileHandler("logs/ServerForNetwork.log");
		...
		ServerSocket ss = new ServerSocket(5056, 50, InetAddress.getByName("0.0.0.0"));
