...
public class TestAppend1000000{

	public static final Logger logger = Logger.getLogger(TestAppend1000000.class.getName());
	...
	public static void main(String[] args) throws IOException 
	{
		...
		try {
			...
			fh = new FileHandler("logs/TestAppend1000000.log");
			...
			try {
				File file = new File("Key-Value-1000000.txt");
	           ...
	           // читаем построчно
				...
				if ( received.equals("1000000") ) {
					System.out.println("Test append - done!!!"); 
					logger.info("Test append - done!!!");
				} else {
					System.out.println("Test append failed! Wrong answer: "+received+", but must be 1000000!"); 
					logger.severe("Test append failed! Wrong answer: "+received+", but must be 1000000!"); 
				}
