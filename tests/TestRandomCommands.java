...
public class TestRandomCommands{

	public static final Logger logger = Logger.getLogger(TestRandomCommands.class.getName());
	...
	public static void main(String[] args) throws IOException 
	{
		...
		try {
			...
			fh = new FileHandler("logs/TestRandomCommands.log");
			...
			try {
				File file = new File("random_commands.txt");
	           ...
	           // читаем построчно
				...
				logger.info("Test ended. \n\tTest execution time: "+duration+" ms");
